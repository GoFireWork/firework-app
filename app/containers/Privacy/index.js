        ...
        <Section width={1}>
          <Container>
            <Services>
              ...
              <p>
                <b>Last updated October 17, 2019</b>
                <br />
                <br />
                Thank you for choosing to be part of our community at stockbase,
                llc, doing business as FireWork (“FireWork”, “we”, “us”, or
                ...
                personal information, please contact us at john@gofirework.com.
                When you visit our website https://gofirework.com, and use our
                ...
                it is important. If there are any terms in this privacy policy
                that you do not agree with, please discontinue use of our Sites
                and our services. This privacy policy applies to all information
                collected through our website (such as https://gofirework.com),
                and/or any related services, sales, marketing or events (we
                refer to them collectively in this privacy policy as the
                "Services"). Please read this privacy policy carefully as it
                will help you make informed decisions about sharing your
              ...
              <p>
                ...
                passwords and security data, payment information, and social
                media login data. We collect personal information that you
                voluntarily provide to us when registering at the Services
                ...
                Services or otherwise contacting us. The personal information
                ...
                include the following: Name and Contact Data. We collect your
                first and last name, email address, postal address, phone
                number, and other similar contact data. Credentials. We collect
                passwords, password hints, and similar security information used
                for authentication and account access. Payment Data. We collect
                ...
                their privacy policy link(s) here: stripe.com .{' '}
              </p>
              <p>
              ...
              <p>
                ...
                such personal information. Information automatically collected
                ...
                visit our Services. We automatically collect certain information
                when you visit, use or navigate the Services. This information
                ...
                Information collected from other sources In Short: We may
                collect limited data from public databases, marketing partners,
                social media platforms, and other outside sources. We may obtain
                ...
                include: social media profile information (your name, gender,
                ...
                listings (such as sponsored links). We will inform you about the
                source of information and the type of information we have
                collected about you within a reasonable period after obtaining
              ...
              <p>
                ...
                on next to each purpose listed below. We use the information we
                collect or receive: To facilitate account creation and logon
                process. If you choose to link your account with us to a third
                party account (such as your Google or Facebook account), we use
                ...
                made through the Services. Request Feedback. We may use your
                information to request feedback and to contact you about your
                use of our Services. To manage user accounts. We may use your
                information for the purposes of managing our account and keeping
                it in working order. To deliver services to the user. We may use
                your information to provide you with the requested service. To
                respond to user inquiries/offer support to users. We may use
              ...
              <p>
                {' '}
                3. WILL YOUR INFORMATION BE SHARED WITH ANYONE? In Short: We
                ...
                on the following legal basis: Consent: We may process your data
                ...
                situations: Vendors, Consultants and Other Third-Party Service
                ...
                to do that work. Examples include: payment processing, data
                analysis, email delivery, hosting services, customer service and
                marketing efforts. We may allow selected third parties to use
              ...
              <p>
                4. WHO WILL YOUR INFORMATION BE SHARED WITH? In Short: We only
                share information with the following third parties. We only
                share and disclose your information with the following third
                parties. We have categorized each party so that you may be
                ...
                us. Allow Users to Connect to their Third-Party Accounts Amazon
                account , Facebook account , and Google account Invoice and
                Billing Stripe User Account Registration and Authentication
                Facebook Login , Google Sign-In , and Login with Amazon Web and
                Mobile Analytics Google Analytics Website Testing Optimizely
              </p>
              <p>
                5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES? In Short:
              ...
              <p>
                {' '}
                6. HOW DO WE HANDLE YOUR SOCIAL LOGINS? In Short: If you choose
              ...
              <p>
                ...
                user's account . When we have no ongoing legitimate business
                need to process your personal information, we will either delete
                or anonymize it, or, if this is not possible (for example,
              ...
              <p>
                9. DO WE COLLECT INFORMATION FROM MINORS? In Short: We do not
                ...
                contact us at john@gofirework.com.
              </p>
              <p>
                {' '}
                10. WHAT ARE YOUR PRIVACY RIGHTS? In Short: In some regions,
                such as the European Economic Area, you have rights that allow
                you greater access to and control over your personal
                information. You may review, change, or terminate your account
                at any time. In some regions (like the European Economic Area),
                ...
                withdrawal. If you are resident in the European Economic Area
                ...
                change the information in your account or terminate your
                account, you can: Log into your account settings and update your
                user account. Contact us using the contact information provided.
                ...
                http://www.aboutads.info/choices/ . Opting out of email
                marketing: You can unsubscribe from our marketing email list at
                any time by clicking on the unsubscribe link in the emails that
                we send or by contacting us using the details provided below.
                You will then be removed from the marketing email list –
                however, we will still need to send you service-related emails
                that are necessary for the administration and use of your
                account. To otherwise opt-out, you may: Contact us using the
                contact information provided. Access your account settings and
                update preferences. Unsubscribe in emails{' '}
              </p>
              <p>
                11. DATA BREACH A privacy breach occurs when there is
                unauthorized access to or collection, use, disclosure or
                disposal of personal information. You will be notified about
                data breaches when stockbase, llc believes you are likely to be
                at risk of serious harm. For example, a data breach may be
                likely to result in serious financial harm or harm to your
                mental or physical well-being. In the event that stockbase, llc
                becomes aware of a security breach which has resulted or may
                result in unauthorized access, use or disclosure of personal
                information stockbase, llc will promptly investigate the matter
                and notify the applicable Supervisory Authority not later than
                72 hours after having become aware of it, unless the personal
                data breach is unlikely to result in a risk to the rights and
                freedoms of natural persons.
              </p>
              <p>
                {' '}
                12. CONTROLS FOR DO-NOT-TRACK FEATURES Most web browsers and
              ...
              <p>
                13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS? In
                ...
                the Services, you have the right to request removal of unwanted
                data that you publicly post on the Services. To request removal
              ...
              <p>
                14. DO WE MAKE UPDATES TO THIS POLICY? In Short: Yes, we will
                update this policy as necessary to stay compliant with relevant
                laws. We may update this privacy policy from time to time. The
              ...
              <p>
                15. HOW CAN YOU CONTACT US ABOUT THIS POLICY? If you have
                questions or comments about this policy, you may email us at
                john@gofirework.com or by post to: stockbase, llc 96 Church
                Street Mountain View, CA 94041 United States
              </p>
              <p>
                HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
                YOU? Based on the laws of some countries, you may have the right
                to request access to the personal information we collect from
                you, change that information, or delete it in some
