...
If you have containers that should be available throughout the app, like a `NavigationBar` (they aren't route specific), you need to add their respective reducers to the root user with the help of `combineReducers`.
...
import navigationBarReducer from 'containers/NavigationBar/user';
