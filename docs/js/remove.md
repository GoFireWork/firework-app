...
1.  Remove three files: `injectSaga.js`, `sagaInjectors.js`, and `user.js`.
...
You'll also need to hook up the history directly to the store. Make changes to `app/language.js`.
